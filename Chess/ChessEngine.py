...
class GameState():
    ...
    def getKnightMoves(self, r, c, moves):
        if self.board[r][c][0] == 'w': # for white's Knight

            # Knight's Forward and Backward Long jumps
            ...
            # Knight's leftwards and Rightward Long jumps
